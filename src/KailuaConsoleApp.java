...
/**
 * Konsol-app til at håndtere Bil, Kunde og Lejekontrakt.
 * Husk at sætte korrekt JDBC-URL, user og password nedenfor.
 */
public class KailuaConsoleApp {
    ...
    public static void main(String[] args) {
        try {
            // Sørg for driver er på classpath (IntelliJ: add Jar -> Compile scope)
